...
export interface BaseUserProfile {
  ...
  referralId: string;
  usertype: "driver" | "customer" | "company";
  // Campos comunes para todos los tipos de usuarios
}

export interface DriverProfile extends BaseUserProfile {
  carType: string;
  car_image: string;
...
export interface CompanyProfile extends BaseUserProfile {
  companyName: string;
  // Otros campos específicos de las compañías
}

// ✅ UserProfile ahora se importa desde authSlice.ts para evitar duplicaciones
// export type UserProfile = DriverProfile | CustomerProfile | CompanyProfile; // ELIMINADO
